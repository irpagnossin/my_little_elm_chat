...
var _user$project$Types$Model = F9(
	function (a, b, c, d, e, f, g, h, i) {
		return {connected: a, message: b, messages: c, room: d, rooms: e, screen: f, server: g, user: h, users: i};
	});
var _user$project$Types$SocketMessage = F4(
	function (a, b, c, d) {
		return {action: a, message: b, room: c, user: d};
	});
var _user$project$Types$UserOut = function (a) {
	return {ctor: 'UserOut', _0: a};
};
var _user$project$Types$UserIn = function (a) {
	return {ctor: 'UserIn', _0: a};
};
var _user$project$Types$ReceiveChatMessage = function (a) {
	return {ctor: 'ReceiveChatMessage', _0: a};
};
var _user$project$Types$SendChatMessage = function (a) {
	return {ctor: 'SendChatMessage', _0: a};
};
var _user$project$Types$SignIn = F2(
	function (a, b) {
		return {ctor: 'SignIn', _0: a, _1: b};
	});
var _user$project$Types$SetUsers = function (a) {
	return {ctor: 'SetUsers', _0: a};
};
var _user$project$Types$SelectRoom = function (a) {
	return {ctor: 'SelectRoom', _0: a};
};
var _user$project$Types$InputUser = function (a) {
	return {ctor: 'InputUser', _0: a};
};
var _user$project$Types$InputMessage = function (a) {
	return {ctor: 'InputMessage', _0: a};
};
var _user$project$Types$Exit = {ctor: 'Exit'};
var _user$project$Types$Clear = {ctor: 'Clear'};
var _user$project$Types$None = {ctor: 'None'};
var _user$project$Types$LoginScreen = {ctor: 'LoginScreen'};
var _user$project$Types$ChatScreen = {ctor: 'ChatScreen'};

var _user$project$Socket$socketMessageDecoder = A3(
	...
	A3(
		...
		A3(
			...
			A3(
				...
				'action',
				_elm_lang$core$Json_Decode$string,
				_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Types$SocketMessage)))));
var _user$project$Socket$receive_message = function (message) {
	var _p0 = A2(_elm_lang$core$Json_Decode$decodeString, _user$project$Socket$socketMessageDecoder, message);
	if (_p0.ctor === 'Ok') {
		var _p1 = _p0._0;
		return _elm_lang$core$Native_Utils.eq(_p1.action, 'USER_IN') ? _user$project$Types$UserIn(_p1.user) : (_elm_lang$core$Native_Utils.eq(_p1.action, 'ALL_USERS') ? _user$project$Types$SetUsers(
			A2(_elm_lang$core$String$split, ',', _p1.message)) : (_elm_lang$core$Native_Utils.eq(_p1.action, 'USER_OUT') ? _user$project$Types$UserOut(_p1.user) : _user$project$Types$ReceiveChatMessage(_p1)));
	} else {
		return _user$project$Types$None;
	}
};
var _user$project$Socket$encodeSocketMessage = function (_p2) {
	var _p3 = _p2;
	return A2(
		...
		_elm_lang$core$Json_Encode$object(
			{
				...
				_0: {
					ctor: '_Tuple2',
					_0: 'action',
					_1: _elm_lang$core$Json_Encode$string(_p3.action)
				},
				_1: {
					ctor: '::',
					_0: {
					...
					_1: {
						...
						_0: {
							ctor: '_Tuple2',
							_0: 'room',
							_1: _elm_lang$core$Json_Encode$string(_p3.room)
						},
						_1: {
							ctor: '::',
							_0: {
								ctor: '_Tuple2',
								_0: 'user',
								_1: _elm_lang$core$Json_Encode$string(_p3.user)
							},
							_1: {ctor: '[]'}
						}
					}
...
var _user$project$State$subscriptions = function (model) {
	return model.connected ? A2(_elm_lang$websocket$WebSocket$listen, model.server, _user$project$Socket$receive_message) : _elm_lang$core$Platform_Sub$none;
};
var _user$project$State$init = function (server) {
	return {
		connected: false,
		message: '',
		messages: {ctor: '[]'},
		...
		screen: _user$project$Types$LoginScreen,
		server: server,
		user: '',
		users: {ctor: '[]'}
	};
	...
	function (msg, model) {
		...
		switch (_p0.ctor) {
			...
			case 'Exit':
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_user$project$State$init(model.server),
					{
						ctor: '::',
						_0: A2(
							_elm_lang$websocket$WebSocket$send,
							model.server,
							_user$project$Socket$encodeSocketMessage(
								A4(_user$project$Types$SocketMessage, 'SIGN_OUT', '', model.room, model.user))),
						_1: {ctor: '[]'}
					});
			case 'InputMessage':
				return A2(
				...
				return A2(
						...
						{message: ''}),
					{
						...
						_0: A2(
							...
							model.server,
							_user$project$Socket$encodeSocketMessage(
								A4(_user$project$Types$SocketMessage, 'USER_SAYS', _p0._0, model.room, model.user))),
						_1: {ctor: '[]'}
					});
			case 'SetUsers':
				return A2(
			...
			case 'SignIn':
				var _p2 = _p0._0;
				var _p1 = _p0._1;
				return (_elm_lang$core$String$isEmpty(_p2) || _elm_lang$core$String$isEmpty(_p1)) ? A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					model,
					{ctor: '[]'}) : A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_elm_lang$core$Native_Utils.update(
						model,
						{connected: true, room: _p1, user: _p2, screen: _user$project$Types$ChatScreen}),
					{
						ctor: '::',
						_0: A2(
							_elm_lang$websocket$WebSocket$send,
							model.server,
							_user$project$Socket$encodeSocketMessage(
								A4(_user$project$Types$SocketMessage, 'REQUEST_USERS', '', model.room, model.user))),
						_1: {
							ctor: '::',
							_0: A2(
								_elm_lang$websocket$WebSocket$send,
								model.server,
								_user$project$Socket$encodeSocketMessage(
									A4(_user$project$Types$SocketMessage, 'SIGN_IN', '', model.room, model.user))),
							_1: {ctor: '[]'}
						}
					});
			case 'UserIn':
				var _p3 = _p0._0;
				var socket_message = A4(
					_user$project$Types$SocketMessage,
					'USER_SAYS',
					A2(_elm_lang$core$Basics_ops['++'], _p3, ' entrou na sala.'),
					model.room,
					'');
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_elm_lang$core$Native_Utils.update(
						model,
						{
							users: {ctor: '::', _0: _p3, _1: model.users},
							messages: {ctor: '::', _0: socket_message, _1: model.messages}
						}),
					{ctor: '[]'});
			default:
				return A2(
...
var _user$project$LoginPage$eligibleUser = function (model) {
	return (_elm_lang$core$String$isEmpty(model.user) || _elm_lang$core$String$isEmpty(model.room)) ? 'btn btn-lg btn-default col-md-offset-3' : 'btn btn-lg btn-primary col-md-offset-3';
};
var _user$project$LoginPage$viewOption = function (opt) {
	return A2(
		_elm_lang$html$Html$option,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Events$onClick(
				_user$project$Types$SelectRoom(opt)),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
...
var _user$project$LoginPage$viewOptions = function (opts) {
	return {
		ctor: '::',
		_0: A2(
			_elm_lang$html$Html$option,
			{ctor: '[]'},
			{ctor: '[]'}),
		_1: A2(_elm_lang$core$List$map, _user$project$LoginPage$viewOption, opts)
	};
};
var _user$project$LoginPage$loginView = function (model) {
	return A2(
					...
					_0: A2(
						...
						},
						{
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text('Escolha a sala:'),
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
								_0: A2(
									...
									_user$project$LoginPage$viewOptions(model.rooms)),
								_1: {ctor: '[]'}
							}
						}),
					_1: {
						...
						_0: A2(
							...
							},
							{
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text('Seu nome:'),
										_1: {ctor: '[]'}
									}),
								_1: {
									ctor: '::',
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Events$onInput(_user$project$Types$InputUser),
											_1: {
												ctor: '::',
					...
					},
					{
						...
						_0: A2(
							_elm_lang$html$Html$button,
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Events$onClick(
									A2(_user$project$Types$SignIn, model.user, model.room)),
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$class(
										_user$project$LoginPage$eligibleUser(model)),
									_1: {ctor: '[]'}
								}
							},
							{
...
var _user$project$ChatPage$format_message = F2(
	function (current_user, _p0) {
		var _p1 = _p0;
		var _p3 = _p1.user;
		var _p2 = _p1.message;
		return _elm_lang$core$String$isEmpty(_p3) ? A2(
			...
			{ctor: '[]'},
			{
				...
				_1: {ctor: '[]'}
			}) : (_elm_lang$core$Native_Utils.eq(current_user, _p3) ? A2(
			_elm_lang$html$Html$li,
			{
				ctor: '::',
				...
				_0: A2(
					...
					{ctor: '[]'},
					{
						...
						_0: _elm_lang$html$Html$text(
							A2(_elm_lang$core$Basics_ops['++'], _p3, ' disse: ')),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
...
var _user$project$ChatPage$viewMessages = function (model) {
	return A2(
		_elm_lang$html$Html$ul,
		{ctor: '[]'},
		A2(
			_elm_lang$core$List$map,
			_user$project$ChatPage$format_message(model.user),
			model.messages));
};
var _user$project$ChatPage$viewUser = F2(
	function (current_user, username) {
		return _elm_lang$core$Native_Utils.eq(current_user, username) ? A2(
			_elm_lang$html$Html$li,
			{ctor: '[]'},
			{
				ctor: '::',
				_0: _elm_lang$html$Html$text(
					A2(_elm_lang$core$Basics_ops['++'], username, '(você)')),
				_1: {ctor: '[]'}
			}) : A2(
			_elm_lang$html$Html$li,
			{ctor: '[]'},
...
var _user$project$ChatPage$viewUsers = function (model) {
	return A2(
		_elm_lang$html$Html$ul,
		{ctor: '[]'},
		A2(
			_elm_lang$core$List$map,
			_user$project$ChatPage$viewUser(model.user),
			model.users));
};
var _user$project$ChatPage$chatView = function (model) {
	return A2(
		_elm_lang$html$Html$section,
		{
			ctor: '::',
			...
			_0: A2(
				...
				{ctor: '[]'},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('users col-md-2'),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
							_0: _user$project$ChatPage$viewUsers(model),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						_0: A2(
							_elm_lang$html$Html$div,
							{
								...
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$class('col-md-10'),
									_1: {
										ctor: '::',
							...
							{
								ctor: '::',
								_0: _user$project$ChatPage$viewMessages(model),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}
				...
				_0: A2(
					...
					},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Events$onInput(_user$project$Types$InputMessage),
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$value(model.message),
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$class('message col-md-9'),
										_1: {
											ctor: '::',
						...
						_1: {
							...
							_0: A2(
								_elm_lang$html$Html$button,
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Events$onClick(
										_user$project$Types$SendChatMessage(model.message)),
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$class('btn btn-lg btn-primary col-md-2 col-md-offset-1'),
										_1: {ctor: '[]'}
									}
								},
								{
					...
					_0: A2(
						...
						},
						{
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Events$onClick(_user$project$Types$Exit),
									_1: {
										ctor: '::',
...
var _user$project$View$inner = function (model) {
	var _p0 = model.screen;
	if (_p0.ctor === 'LoginScreen') {
		return _user$project$LoginPage$loginView(model);
	} else {
		return _user$project$ChatPage$chatView(model);
	}
};
var _user$project$View$root = function (model) {
	return A2(
		...
		},
		{
			...
			_0: A2(
				...
				},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('My little Elm chat client'),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: _user$project$View$inner(model),
				_1: {
					ctor: '::',
					_0: A2(
							...
							_0: A2(
								...
								{ctor: '[]'},
								{
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$href('https://creativecommons.org/licenses/by/4.0/legalcode'),
											_1: {ctor: '[]'}
										},
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text('CC BY 4.0'),
											_1: {ctor: '[]'}
										}),
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html$text(' irpagnossin 2017'),
										_1: {ctor: '[]'}
									}
								}),
							_1: {ctor: '[]'}
...
var _user$project$App$server = 'ws://localhost:9001';
var _user$project$App$main = _elm_lang$html$Html$program(
	{
		init: A2(
			_elm_lang$core$Platform_Cmd_ops['!'],
			_user$project$State$init(_user$project$App$server),
			{ctor: '[]'}),
